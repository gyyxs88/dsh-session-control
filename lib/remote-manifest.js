...
export function validateRemoteProjectManifest(manifest = REMOTE_PROJECT_MANIFEST) {
  ...
  if (!Array.isArray(manifest.capabilities) || !manifest.capabilities.includes('session-control.port') || !manifest.capabilities.includes('remote-project.open')) throw new Error('remote project capabilities are invalid')
