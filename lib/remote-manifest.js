...
export const REMOTE_PROJECT_MANIFEST = Object.freeze({
  ...
  protocolVersion: '1.0',
  apiVersion: '1.0',
  dshCompatibility: Object.freeze({ min: '0.1.0-rc.6', max: '0.1.0-rc.6' }),
  ...
  bundledSkills: Object.freeze([Object.freeze({
    ...
    version: '0.6.0',
    sha256: 'c09fc69820b59363e1fd51440c6d84895cac8768d4911eb9fd8ff926272fbb30',
  })]),
})
...
export function validateRemoteProjectManifest(manifest = REMOTE_PROJECT_MANIFEST) {
  ...
  if (!Array.isArray(manifest.capabilities) || ['session-control.port', 'remote-project.open', 'remote-project.schedule-delete', 'remote-project.runtime-auth-begin', 'remote-project.runtime-auth-confirm', 'remote-project.execution-policy-verify'].some((capability) => !manifest.capabilities.includes(capability))) throw new Error('remote project capabilities are invalid')
